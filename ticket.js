...
window.onload = function () {
    ...
    document.getElementById("theatre-name").innerHTML = theatre_name;
    ...
    document.getElementById("ticket-numb").innerHTML = ticket;
    document.getElementById("seat-numb").innerHTML = `${ticket1} ${ticket2} ${ticket3} ${ticket4} ${ticket5}`;
    
    
    document.getElementById("amnt").innerHTML =  `Rs. ${amnt+56}.00`;
